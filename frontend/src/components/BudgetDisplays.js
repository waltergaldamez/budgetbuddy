...
export default class BudgetDisplays extends React.Component {
  ...
  render() {
    const { budgets, show, currentBudget, allowance, diff, index } = this.state;
    var newName = '', newGoal ='';
          ...
          <div className="inline">
            ...
            <div className="budget-card-display">
              ...
              <div className="budget-card-inner-display">
                ...
                {
                  budget.BudgetGoal - budget.BudgetProgress == 0 ? <Button variant="success" onClick={deleteBudget2} data-id={budget._id} data-index={i} className="progress-submit">
                  <span className="material-icons ">
                    check
                  </span>
                  <span className="save">
